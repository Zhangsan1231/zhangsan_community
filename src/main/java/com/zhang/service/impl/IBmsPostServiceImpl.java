...
import com.zhang.mapper.BmsTagMapper;
import com.zhang.mapper.BmsTopicMapper;
import com.zhang.mapper.BmsTopicTagMapper;
...
import com.zhang.model.entity.BmsTopicTag;
...
public class IBmsPostServiceImpl extends ServiceImpl<BmsTopicMapper, BmsPost> implements IBmsPostService {
    ...
    @Resource
    private com.zhang.service.IBmsTopicTagService IBmsTopicTagService;
    @Override
    public Page<PostVO> getList(Page<PostVO> page, String tab) {
        ...
        iPage.getRecords().forEach(topic ->{
            ...
            if(!topicTags.isEmpty()){
                ...
                List<BmsTag> bmsTags = bmsTagMapper.selectBatchIds(tagIds);
                topic.setTags(bmsTags);
            }
        });
        setTopicTags(iPage);
        return iPage;
